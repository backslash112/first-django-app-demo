...
def create_question(question_text, days):
    ...
    numbers of 'days' offset to now (negative for questions published
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_two_past_questions(self):
        """
        The questions index page should be displayed multiple questions.
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of a question with a pub_date in the past should be display the question's text.
        """
